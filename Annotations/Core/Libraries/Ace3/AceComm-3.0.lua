...
---@param method function|string|nil OPTIONAL: Callback to call on message reception: Function reference, or method name (string) to call on self. Defaults to "OnCommReceived"
--- ---
...
---@param target string|nil Destination for some distributions; see SendAddonMessage API
---@param prio "BULK"|"NORMAL"|"ALERT"|nil OPTIONAL: ChatThrottleLib priority, "BULK", "NORMAL" or "ALERT". Defaults to "NORMAL".
---@param callbackFn function|nil OPTIONAL: callback function to be called as each chunk is sent. receives 3 args: the user supplied arg (see next), the number of bytes sent so far, and the number of bytes total to send.
