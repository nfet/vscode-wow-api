...
---@alias AceConfigRegistry.OptionsGetter fun(uiType: AceConfigRegistry.UIType, uiName: string|nil, errlvl?: number): table

-- ----------------------------------------------------------------------------
-- AceConfigRegistry-3.0
-- ----------------------------------------------------------------------------

---@class AceConfigRegistry_3_0
local lib = {}
...
---@param uiType AceConfigRegistry.UIType|nil The type of UI to get the table for
---@param uiName string|nil The name of the library/addon querying for the table, e.g. "MyLib-1.0"
...
---@param skipValidation boolean|nil Skip options table validation (primarily useful for extremely huge options, with a noticeable slowdown)
...
---@param errlvl number|nil Error level offset, default 0 (=errors point to the function calling :ValidateOptionsTable)
